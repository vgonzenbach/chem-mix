...
The present notebook visualizes significant relationships of chemical mixtures to different outcomes: neurotransmitter levels, cortical thickness estimates and cortical and subcortical brain volumes. One network is visualized for each of the following time windows: prenatal, birth, three year. 
...
vizNetwork <- function(vis.nodes, vis.links){
  ...
  visnet <- visNetwork(vis.nodes, vis.links, width = 7, height = 10) %>% 
